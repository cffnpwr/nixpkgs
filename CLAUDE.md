...
This is a personal Nixpkgs repository that provides custom packages, Home Manager modules, nix-darwin modules, and NixOS modules. The repository is structured as a Nix Flake.
